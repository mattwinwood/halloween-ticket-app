...
-->
<template>
  <div id="Gallery" class="bg-black max-w-7xl mx-auto sm:px-6 lg:px-8 my-24">
<!--    <h1 class="text-4xl py-8 tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">-->
<!--      <span class="block text-indigo-600 xl:inline">Gallery</span>-->
<!--      <span class="block xl:inline">Payment</span>-->
<!--    </h1>-->
